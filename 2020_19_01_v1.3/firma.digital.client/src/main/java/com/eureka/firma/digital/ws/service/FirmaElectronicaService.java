...
@WebServiceClient(
    ...
    wsdlLocation = "http://fiel.asa.gob.mx/digitalSignWSSS/servicios/FirmaElectronica?wsdl",
...
public class FirmaElectronicaService extends Service {
    ...
    static {
         ...
         *  BEFORE DEPLOY:  set correct URL according to the execution environment
         */
        /*String stringURL = "http://fiel.asa.gob.mx/digitalSignWSSS/servicios/FirmaElectronica?wsdl"; */
        String stringURL = "http://localhost:8080/digitalSignWSSS/servicios/FirmaElectronica?wsdl";
        
        try {
            url = new URL( stringURL);
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(FirmaElectronicaService.class.getName()).log(
                java.util.logging.Level.INFO,  "Can not initialize the default wsdl from {0}", stringURL
            );
        }
        WSDL_LOCATION = url;
    }
